...
exports.createCourse = async (req, res) => {
    try{   
        ...
        let {courseName, courseDescription, whatYouWillLearn, price, 
                tag:_tag, category, status, instructions:_instructions } = req.body;
      ...
      // Convert the tag and instructions from stringified Array to Array
        ...
        if(!courseName || !courseDescription || !whatYouWillLearn || !price 
            || !tag.length || !thumbnail || !category || !instructions.length){
...
exports.getCourseDetails = async (req, res) =>{
    try{
        ...
        return res.status(500).json({
            success:false,
            message: "Error while getting courseDetails Data!. can not fetch the course details",
        });
    }
}
